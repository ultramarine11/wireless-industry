...
import ru.wirelesstools.item.weapon.VampireQuantumBowEU;
...
import ru.wirelesstools.tiles.TileMachinesCharger;
...
public class MainWI {
	...
	public void preInit(FMLPreInitializationEvent event) {
		...
		try {
			...
			if (eutorf < 1) {
				// EuToRfmultiplier = 1;
				ConfigWI.EuToRfmultiplier = 1;
			} else {
				// EuToRfmultiplier = eutorf;
				ConfigWI.EuToRfmultiplier = eutorf;
			}
			...
			if (stolenEUlocal > 0) {
				...
				ConfigWI.stolenEnergyEUFromArmor = 0;
			}
		...
		quantumVampBowEu = new VampireQuantumBowEU("qvampboweu");
	...
	public void init(FMLInitializationEvent event) {
		...
		// EntityRegistry.registerGlobalEntityID(ArrowVampEU.class, "ArrowVampEU",
