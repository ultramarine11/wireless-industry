...
public class BlockExpGen extends BlockContainer {
	...
	public void registerBlockIcons(IIconRegister reg) {
		...
		this.icons[0][0] = reg.registerIcon(Reference.PathTex + "blockXPgen_side_bottom");
		...
		this.icons[0][6] = reg.registerIcon(Reference.PathTex + "blockXPgen_side_bottom");
	...
	public IIcon getIcon(IBlockAccess blockaccess, int x, int y, int z, int blockSide) {
		...
		} else if (!this.isActive(blockaccess, x, y, z)) {
