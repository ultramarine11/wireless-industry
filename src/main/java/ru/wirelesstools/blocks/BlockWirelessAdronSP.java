...
public class BlockWirelessAdronSP extends BlockContainer {

    private IIcon[] icons;

    public BlockWirelessAdronSP(String unlocalizedName) {
        super(Material.rock);
    ...
    public TileEntity createNewTileEntity(World p_149915_1_, int p_149915_2_) {
        return new TileWirelessAdronSP();
    }

    public void registerBlockIcons(IIconRegister reg) {
        this.icons = new IIcon[3];
        this.icons[0] = reg.registerIcon(Reference.PathTex + "all_bottom");
        this.icons[1] = reg.registerIcon(Reference.PathTex + "adsp_top");
        this.icons[2] = reg.registerIcon(Reference.PathTex + "adsp_side");
    }
    ...
    public void onBlockPlacedBy(World world, int x, int y, int z, EntityLivingBase entity, ItemStack itemStack) {
        TileWirelessAdronSP tile = (TileWirelessAdronSP)world.getTileEntity(x, y, z);
    ...
    public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int side, float subX,
        ...
        if (!world.isRemote) {
            TileWirelessAdronSP te = (TileWirelessAdronSP) world.getTileEntity(x, y, z);
