...
public class BlockWirelessUHSP extends BlockContainer {

	private IIcon[] icons;

	public BlockWirelessUHSP(String unlocalizedName) {
		super(Material.rock);
	...
	public void registerBlockIcons(IIconRegister reg) {
		...
		this.icons[1] = reg.registerIcon(Reference.PathTex + "usp_top");
		this.icons[2] = reg.registerIcon(Reference.PathTex + "uhsp_side");
	}
	...
	public TileEntity createNewTileEntity(World p_149915_1_, int p_149915_2_) {
		...
		return new TileWirelessUHSP();
	}
	
	public void onBlockPlacedBy(World world, int x, int y, int z, EntityLivingBase entity, ItemStack itemStack) {
		TileWirelessUHSP tile = (TileWirelessUHSP)world.getTileEntity(x, y, z);
	...
	public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int side, float subX,
		...
		if (!world.isRemote) {
			TileWirelessUHSP te = (TileWirelessUHSP) world.getTileEntity(x, y, z);
