...
public class BlockWirelessASP extends BlockContainer {

	private IIcon[] icons;

	public BlockWirelessASP(String unlocalizedName) {
		super(Material.rock);
	...
	public void registerBlockIcons(IIconRegister reg) {
		...
		this.icons[1] = reg.registerIcon(Reference.PathTex + "asp_top");
		this.icons[2] = reg.registerIcon(Reference.PathTex + "asp_side");
	}
	...
	public TileEntity createNewTileEntity(World p_149915_1_, int p_149915_2_) {
		...
		return new TileWirelessASP();
	}
	
	public void onBlockPlacedBy(World world, int x, int y, int z, EntityLivingBase entity, ItemStack itemStack) {
		TileWirelessASP tile = (TileWirelessASP)world.getTileEntity(x, y, z);
	...
	public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int side, float subX,
		...
		if (!world.isRemote) {
			TileWirelessASP te = (TileWirelessASP)world.getTileEntity(x, y, z);
