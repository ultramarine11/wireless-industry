...
public class BlockWirelessNeuSPPersonal extends BlockContainer {

	private IIcon[][] icons;

	public BlockWirelessNeuSPPersonal(String unlocalizedName, Material mat) {
		super(mat);
	...
	public void registerBlockIcons(IIconRegister reg) {
		...
		this.icons[0][1] = reg.registerIcon(Reference.PathTex + "nsp_top");
		this.icons[0][2] = reg.registerIcon(Reference.PathTex + "nsp_side");
	}
	...
	public TileEntity createNewTileEntity(World p_149915_1_, int p_149915_2_) {
		...
		return new TileWirelessNeutronSPPersonal();
	}
	
	public void onBlockPlacedBy(World world, int x, int y, int z, EntityLivingBase entity, ItemStack itemStack) {
		TileWirelessNeutronSPPersonal tile = (TileWirelessNeutronSPPersonal)world.getTileEntity(x, y, z);
	...
	public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int side, float subX,
		...
		if (!world.isRemote) {
			...
			TileWirelessNeutronSPPersonal te = (TileWirelessNeutronSPPersonal) world.getTileEntity(x, y, z);
