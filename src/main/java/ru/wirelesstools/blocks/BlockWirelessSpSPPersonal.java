...
public class BlockWirelessSpSPPersonal extends BlockContainer {

	private IIcon[][] icons;

	public BlockWirelessSpSPPersonal(String unlocalizedName, Material mat) {
		super(mat);
	...
	public void registerBlockIcons(IIconRegister reg) {
		...
		this.icons[0][1] = reg.registerIcon(Reference.PathTex + "spsp_top");
		this.icons[0][2] = reg.registerIcon(Reference.PathTex + "wireless_spsp_side");
	...
	public TileEntity createNewTileEntity(World world, int p_149915_2_) {
		...
		return new TileWirelessSpSPPersonal();
	}
	
	public void onBlockPlacedBy(World world, int x, int y, int z, EntityLivingBase entity, ItemStack itemStack) {
		TileWirelessSpSPPersonal tile = (TileWirelessSpSPPersonal)world.getTileEntity(x, y, z);
	...
	public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int side, float subX,
		...
		if (!world.isRemote) {
			...
			TileWirelessSpSPPersonal te = (TileWirelessSpSPPersonal) world.getTileEntity(x, y, z);
