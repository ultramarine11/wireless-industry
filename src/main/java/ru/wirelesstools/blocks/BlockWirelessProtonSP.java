...
public class BlockWirelessProtonSP extends BlockContainer {

	private IIcon[] icons;

	public BlockWirelessProtonSP(String unlocalizedName) {
		super(Material.rock);
	...
	public void registerBlockIcons(IIconRegister reg) {
		...
		this.icons[1] = reg.registerIcon(Reference.PathTex + "psp_top");
		this.icons[2] = reg.registerIcon(Reference.PathTex + "proton_sp_side");
	}
	...
	public TileEntity createNewTileEntity(World p_149915_1_, int p_149915_2_) {
		...
		return new TileWirelessProtonSP();
	}
	
	public void onBlockPlacedBy(World world, int x, int y, int z, EntityLivingBase entity, ItemStack itemStack) {
		TileWirelessProtonSP tile = (TileWirelessProtonSP)world.getTileEntity(x, y, z);
	...
	public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int side, float subX,
		...
		if (!world.isRemote) {
			TileWirelessProtonSP te = (TileWirelessProtonSP) world.getTileEntity(x, y, z);
