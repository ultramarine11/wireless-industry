...
public class BlockWirelessBarionSP extends BlockContainer {
    ...
    public BlockWirelessBarionSP(String unlocalizedName) {
        super(Material.rock);
    ...
    public void registerBlockIcons(IIconRegister reg) {
        ...
        this.icons[1] = reg.registerIcon(Reference.PathTex + "bsp_top");
        this.icons[2] = reg.registerIcon(Reference.PathTex + "bsp_side");
    }
    ...
    public void onBlockPlacedBy(World world, int x, int y, int z, EntityLivingBase entity, ItemStack itemStack) {
        TileWirelessBarionSP tile = (TileWirelessBarionSP)world.getTileEntity(x, y, z);
    ...
    public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int side, float subX,
        ...
        if (!world.isRemote) {
            TileWirelessBarionSP te = (TileWirelessBarionSP) world.getTileEntity(x, y, z);
